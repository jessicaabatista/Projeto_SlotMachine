...
private int a ,b ,c ,d ,e ,f ,g ,h ,i; //posiçoes dos elementos do jogo de azar
...
public String escolha1; // Escolher quanto você quer depositar no jogo (metodo ComprarCredito)
public int x;
public int y;//Valor depositado nos vetores apos realizar o ramdom com possibilidades diferentes
public int z;//Variavel de manuntenção utilizado somente para espaçamentos
...
protected void Sacar() {
	...
	if (this.credito > 0) {// Verificação para ver se tem credito
		
		this.dinheiro = this.credito*0.5; //Convertendo credito para dinheiro
		
		this.credito = 0;
		
		System.out.println("Você conseguiu R$ " + this.dinheiro + " parabéns!");
		System.out.println("Obrigado por jogar conosco.");
		
	}else{
		System.out.println("ERRO: Você não possui créditos para sacar.");
	}
}
...
protected void Verificacao() {
	...
	while (this.choose == 1) {
	   ...
	   if(this.X < 5){
		...
		//A partir daqui é verificação dos padrões
							...
							if (this.a == this.b && this.b == this.c && this.c == this.d && this.d == this.e && this.e == this.f &&this.f == this.i ) {
								...
								if (this.c == this.d && this.d == this.e && this.e == this.f && this.f == this.g && this.g == this.h &&this.h == this.i ) {
									...
									if (this.a == this.d && this.d == this.e && this.e == this.f && this.f == this.g && this.g == this.h &&this.h == this.i ) {
										...
										}else//AQUI COMEÇA OS PADROES RAROS
...
protected void MostrarTudo() {
	...
	System.out.println("|     PONTUAÇÃO ELEMENTOS                       MULTIPLICADOR PADRÕES                 |");
	System.out.println("|                                                                                     |");
	System.out.println("|  ELEMENTO [0] = 50 CREDITOS                   COMUM [1 PADRAO] = X1                 |");
	System.out.println("|  ELEMENTO [1] = 60 CREDITOS                  RARO [2 PADRÕES] = X10                 |");
	System.out.println("|  ELEMENTO [2] = 70 CREDITOS              CLASSE SS [3 PADRÕES] = X3.000             |");
	System.out.println("|  ELEMENTO [3] = 80 CREDITOS              CLASSE SSS [4 PADRÕES] = X5.000            |");
